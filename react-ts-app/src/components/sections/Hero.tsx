          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["React", "TypeScript", "Node.js", "Android", "Python", "MySQL"].map((tech, i) => (
              <motion.span
                ...
                className="px-4 py-2 rounded-full border border-glass-border bg-glass-bg/30 backdrop-blur-sm text-sm text-muted-foreground select-none transition-all duration-300 hover:text-neon-cyan"
              >
                {tech}
              </motion.span>
            ))}
